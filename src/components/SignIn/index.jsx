  ...
  return (
    <>
      <div>
        ...
        {profile ? (
          <div>
            <img src={profileLogin.picture} alt="user image" />
            <h3>User Logged in</h3>
            <p>Name: {profileLogin.name}</p>
            <p>Email Address: {profileLogin.email}</p>
            <br />
            <br />
